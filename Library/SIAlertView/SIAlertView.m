...
- (UIButton *)buttonForItemIndex:(NSUInteger)index
{
	...
	switch (item.type) {
		...
		default:
            ...
            if (index == 0) {
                // [button setFlatImage:[UIImage imageNamed:@"fb_icon@2x.jpg"]];
                [button setImage:[UIImage imageNamed:@"actionsheet_facebook"] forState:UIControlStateNormal];
            }
            else if(index == 1){
                //[button setFlatImage:[UIImage imageNamed:@"wechat"]];
                [button setImage:[UIImage imageNamed:@"wechat"] forState:UIControlStateNormal];
            }
            else if(index == 2){
                //[button setFlatImage:[UIImage imageNamed:@"wechat"]];
                [button setImage:[UIImage imageNamed:@"weibo"] forState:UIControlStateNormal];
            }
