...
-(void)reviewCall{
    [[AustinApi sharedInstance]getReview:API_REVIEW_ORDER_HOT1W page:nil uid:nil function:^(NSArray *returnData) {
...
-(void)topicCall{
    [[AustinApi sharedInstance]getTopic:API_TOPIC_TYPE_CLASSIC vid:nil page:nil uid:nil function:^(NSArray *returnData) {
        //     NSLog(@"bbb%@",returnData);
