...
- (void)viewDidLoad {
    ...
    [self.avatar sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",[returnData objectForKey:@"AvatarUrl"]]] placeholderImage:[UIImage imageNamed:@"placeholder-poster.jpg"]];
